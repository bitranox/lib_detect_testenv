Hier ist dein Konzept – **unverändert in Struktur & Inhalt**, aber mit dem Bibliotheksnamen **`lib_detect_testenv`** durchgängig aktualisiert.
...
* **Dump-API:** `lib_detect_testenv.dump(format="text"|"json"|"html", path=None)`
...
**Modulname:** `lib_detect_testenv`

```python
import lib_detect_testenv as log
...
>
> * Minimal: `pip install lib_detect_testenv`
> * Mit Rich: `pip install lib_detect_testenv[rich]`
> * Mit Graylog: `pip install lib_detect_testenv[gelf]`
> * Komplett: `pip install lib_detect_testenv[rich,gelf,journald,eventlog]`
...
Wenn du willst, liefere ich dir als Nächstes ein kleines **Starter-Skeleton** für `lib_detect_testenv` (Package-Layout, Handler-Stubs, Rich-Theme, HTML-Dump) – ready to run.
