...
* src/lib_detect_testenv/behaviors.py
* src/lib_detect_testenv/cli.py
* src/lib_detect_testenv/__main__.py
* src/lib_detect_testenv/__init__.py
* src/lib_detect_testenv/__init__conf__.py
* tests/test_cli.py
...
* **Location:** src/lib_detect_testenv/behaviors.py
...
* **Location:** src/lib_detect_testenv/cli.py
...
* **Purpose:** Provide ``python -m lib_detect_testenv`` entry point by
...
* **Location:** src/lib_detect_testenv/__init__conf__.py
...
1. ``lib_detect_testenv`` → prints CLI help (no default action).
2. ``lib_detect_testenv hello`` → prints greeting.
3. ``lib_detect_testenv fail`` → prints truncated traceback.
4. ``lib_detect_testenv --traceback fail`` → prints full rich traceback.
5. ``python -m lib_detect_testenv --traceback fail`` → matches console output.
